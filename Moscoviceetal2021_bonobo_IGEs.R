...
fai.model<- brm(bnb.fai~Habitat+(1|Plot), data=FAI, family=hurdle_gamma(), prior=
                  c(prior(normal(0,50), class=Intercept),
                    ...
                    prior(normal(0,5), class=b, coef="Habitateast"),
...
# do West activity scans differ among baseline, incursion and IGE contexts? (ECO 3 and ICD/ICT 3, see results section Figure 2 and ESM Table 4)
...
# Analysis of log cortisol concentrations (ng/ml SG) by context (ICD/ICT 5, see results section, Figure 5 and Table 6)
